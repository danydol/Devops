...
import {
  ...
  id = "nova-eks-node-role/arn:aws:iam::aws:policy/AmazonEKSWorkerNodePolicy"
}
...
import {
  ...
  id = "nova-eks-node-role/arn:aws:iam::aws:policy/AmazonEKS_CNI_Policy"
}
...
import {
  ...
  id = "nova-eks-node-role/arn:aws:iam::aws:policy/AmazonEC2ContainerRegistryReadOnly"
}
