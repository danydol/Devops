...
resource "aws_subnet" "gwlbe_subnet1" {
  ...
  tags = {
    Name = "Checkpoint GWLBe Subnet 1"
    Network = "Private"
  }
}
resource "aws_route_table" "gwlbe_subnet1_rtb" {
  ...
  tags = {
    Name = "Checkpoint GWLBe Subnet 1 Route Table"
    Network = "Private"
  }
}
...
resource "aws_subnet" "gwlbe_subnet2" {
  ...
  tags = {
    Name = "Checkpoint GWLBe subnet 2"
    Network = "Private"
  }
}
resource "aws_route_table" "gwlbe_subnet2_rtb" {
  ...
  tags = {
    Name = "Checkpoint GWLBe Subnet 2 Route Table"
    Network = "Private"
  }
}
...
resource "aws_subnet" "gwlbe_subnet3" {
  ...
  tags = {
    Name = "Checkpoint GWLBe subnet 3"
    Network = "Private"
  }
}
resource "aws_route_table" "gwlbe_subnet3_rtb" {
  ...
  tags = {
    Name = "Checkpoint GWLBe Subnet 3 Route Table"
    Network = "Private"
  }
}
...
resource "aws_subnet" "gwlbe_subnet4" {
  ...
  tags = {
    Name = "Checkpoint GWLBe subnet 4"
    Network = "Private"
  }
}
resource "aws_route_table" "gwlbe_subnet4_rtb" {
  ...
  tags = {
    Name = "Checkpoint GWLBe Subnet 4 Route Table"
    Network = "Private"
  }
}
...
resource "aws_route_table" "nat_gw_subnet1_rtb" {
  ...
  tags = {
    Name = "Checkpoint NAT Subnet 1 Route Table"
    Network = "Public"
  }
}
...
resource "aws_route_table" "nat_gw_subnet2_rtb" {
  ...
  tags = {
    Name = "Checkpoint NAT Subnet 2 Route Table"
    Network = "Public"
  }
}
...
resource "aws_route_table" "nat_gw_subnet3_rtb" {
  ...
  tags = {
    Name = "Checkpoint NAT Subnet 3 Route Table"
    Network = "Public"
  }
}
...
resource "aws_route_table" "nat_gw_subnet4_rtb" {
  ...
  tags = {
    Name = "Checkpoint NAT Subnet 4 Route Table"
    Network = "Public"
  }
}
...
resource "aws_vpc_endpoint" "gwlb_endpoint1" {
  ...
  tags = {
    "Name" = "checkpoint_gwlb_endpoint1"
  }
}
resource "aws_vpc_endpoint" "gwlb_endpoint2" {
  ...
  tags = {
    "Name" = "checkpoint_gwlb_endpoint2"
  }
}
resource "aws_vpc_endpoint" "gwlb_endpoint3" {
  ...
  tags = {
    "Name" = "checkpoint_gwlb_endpoint3"
  }
}
resource "aws_vpc_endpoint" "gwlb_endpoint4" {
  ...
  tags = {
    "Name" = "checkpoint_gwlb_endpoint4"
  }
}
...
resource "aws_route_table" "tgw_attachment_subnet1_rtb" {
  ...
  tags = {
    Name = "Checkpoint TGW Attachment Subnet 1 Route Table"
    Network = "Private"
  }
}
...
resource "aws_route_table" "tgw_attachment_subnet2_rtb" {
  ...
  tags = {
    Name = "Checkpoint TGW Attachment Subnet 2 Route Table"
    Network = "Private"
  }
}
...
resource "aws_route_table" "tgw_attachment_subnet3_rtb" {
  ...
  tags = {
    Name = "Checkpoint TGW Attachment Subnet 3 Route Table"
    Network = "Private"
  }
}
...
resource "aws_route_table" "tgw_attachment_subnet4_rtb" {
  ...
  tags = {
    Name = "Checkpoint TGW Attachment Subnet 4 Route Table"
    Network = "Private"
  }
}
