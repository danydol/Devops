...
resource "aws_iam_role_policy_attachment" "management_additional_policy_1" {
  count      = local.new_instance_profile_general > 0 ? 1 : 0
  role       = module.cme_iam_role[0].cme_iam_role_name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
}


resource "aws_iam_role_policy_attachment" "management_additional_policy_2" {
  count      = local.new_instance_profile_general > 0 ? 1 : 0
  role       = module.cme_iam_role[0].cme_iam_role_name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedEC2InstanceDefaultPolicy"
}

resource "aws_iam_role_policy_attachment" "management_gwlb_additional_policy_1" {
  count      = local.new_instance_profile_gwlb > 0 ? 1 : 0
  role       = module.cme_iam_role_gwlb[0].cme_iam_role_name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
}


resource "aws_iam_role_policy_attachment" "management_gwlb_additional_policy_2" {
  count      = local.new_instance_profile_gwlb > 0 ? 1 : 0
  role       = module.cme_iam_role_gwlb[0].cme_iam_role_name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedEC2InstanceDefaultPolicy"
}
